...
export const en: Messages = {
	...
	view: {
		...
		effortTooltip:
			"Reasoning depth for supported models (Sonnet 4.6 / Opus 4.6, etc.). 'auto' defers to the CLI / ~/.claude/settings.json default. Haiku does not support effort and the value is ignored.",
